package br.itc.movies.ui.adapters
...
import br.itc.movies.ui.activities.MovieActivity
...
class MoviePagedListAdapter(val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class MovieItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Movie?, context: Context) {
            ...
            itemView.findViewById<MaterialTextView>(R.id.cv_genre).text =
                movie?.genresNowPlaying?.joinToString { it.name }
